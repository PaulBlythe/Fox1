...
{
    public class SmallButton :GuiItem
    {
        Vector4 src_down;
        Vector4 src_normal;
        Vector4 src_up;
        ...
        public SmallButton(String Text, String EventID)
        {
            text = Text;
            evt = EventID;
        ...
        {
            src_down = new Vector4(GuiManager.Instance.SmallButtonSource[0], GuiManager.Instance.SmallButtonSource[1], GuiManager.Instance.SmallButtonSource[2], GuiManager.Instance.SmallButtonSource[3]);
            src_normal = new Vector4(GuiManager.Instance.SmallButtonSource[4], GuiManager.Instance.SmallButtonSource[5], GuiManager.Instance.SmallButtonSource[6], GuiManager.Instance.SmallButtonSource[7]);
            src_up = new Vector4(GuiManager.Instance.SmallButtonSource[8], GuiManager.Instance.SmallButtonSource[9], GuiManager.Instance.SmallButtonSource[10], GuiManager.Instance.SmallButtonSource[11]);
        ...
        public override void Position(Vector4 position)
        {
            ...
            Vector2 ts = GuiManager.Instance.GetFont(GuiManager.FontStyle.Smaller).MeasureString(text);
            text_pos = new Vector2(cx - (ts.X * 0.5f), cy + 5);
        ...
        public override void Draw(GlyphBatch batch)
        {
            ...
            {
                SDFFont font = GuiManager.Instance.GetFont(GuiManager.FontStyle.Smaller);
