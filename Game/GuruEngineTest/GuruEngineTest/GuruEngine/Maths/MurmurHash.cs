...
namespace GuruEngine.Maths
{
    public class MurmurHash
    {
        ...
        private uint seed = 123456; // if want to start with a seed, create a constructor
        ulong h1;
        ulong h2;
        ...
        public UInt128 ComputeHash(byte[] bb)
        {
            ProcessBytes(bb);
            return Hash;
        }

        public UInt128 ComputeHash(String s)
        {
        ...
        public UInt128 Hash
        {
            get
            {
                ...
                h1 = MurmurHash.MixFinal(h1);
                h2 = MurmurHash.MixFinal(h2);
