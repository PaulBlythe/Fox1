    ...
    public struct Matrix33D : IEquatable<Matrix33D>
    {
        ...
        public bool IsOrthogonal
        {
            get
            {
                ...
                return AreNumericallyEqual(Identity, this * Transposed, Double.Epsilon * 10);
            }
        }
        ...
        public bool IsRotation
        {
            get
            {
                ...
                return Double.Equals(1, Determinant) && IsOrthogonal;
            }
        }
        ...
        public bool TryInvert()
        {
            ...
            if (DoubleClassExtension.IsZero(determinant, Double.Epsilon *Double.Epsilon * Double.Epsilon * Double.Epsilon))
                return false;
