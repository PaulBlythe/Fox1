...
namespace GuruEngine.Algebra
{
    public struct Matrix33 : IEquatable<Matrix33>
    {
        ...
        /// <summary>
        /// Returns a <see cref="Matrix33"/> with all of its components set to zero.
        /// </summary>
        public static readonly Matrix33 Zero = new Matrix33(0, 0, 0, 0, 0, 0, 0, 0, 0);

        /// <summary>
        /// Returns a <see cref="Matrix33"/> with all of its components set to one.
        /// </summary>
        public static readonly Matrix33 One = new Matrix33(1, 1, 1, 1, 1, 1, 1, 1, 1);

        /// <summary>
        /// Returns the 3 x 3 identity matrix.
        /// </summary>
        public static readonly Matrix33 Identity = new Matrix33(1, 0, 0, 0, 1, 0, 0, 0, 1);
        #endregion
        ...
        public bool IsOrthogonal
        {
            get
            {
                ...
                return AreNumericallyEqual(Identity, this * Transposed, float.Epsilon * 10);
            }
        }
        ...
        public bool IsRotation
        {
            get
            {
                ...
                return DoubleClassExtension.AreEqual(1, Determinant) && IsOrthogonal;
            }
        }
        ...
        /// </remarks>
        public Matrix33(float elementValue)
        ...
        /// </exception>
        public Matrix33(float[] elements, MatrixOrder order)
        {
        ...
        /// <paramref name="elements"/> must not be <see langword="null"/>.
        /// </exception>
        public Matrix33(IList<float> elements, MatrixOrder order)
        {
            if (order == MatrixOrder.RowMajor)
            {
                // First row
        ...
        /// </exception>
        public Matrix33(float[,] elements)
        {
        ...
        {
            return ((obj is Matrix33) && (this == (Matrix33)obj));
        }


        #region IEquatable<Matrix33> Members
        /// <summary>
        ...
        /// <param name="matrix2">The second Matrix.</param>
        /// <returns>The sum of the two matrices.</returns>
        public static Matrix33 Add(Matrix33 matrix1, Matrix33 matrix2)
        {
            matrix1.M00 += matrix2.M00; matrix1.M01 += matrix2.M01; matrix1.M02 += matrix2.M02;
            matrix1.M10 += matrix2.M10; matrix1.M11 += matrix2.M11; matrix1.M12 += matrix2.M12;
            matrix1.M20 += matrix2.M20; matrix1.M21 += matrix2.M21; matrix1.M22 += matrix2.M22;
        ...
        public static Matrix33 operator -(Matrix33 minuend, Matrix33 subtrahend)
        {
        ...
        /// <param name="subtrahend">The second matrix (subtrahend).</param>
        /// <returns>The difference of the two matrices.</returns>
        public static Matrix33 Subtract(Matrix33 minuend, Matrix33 subtrahend)
        {
            minuend.M00 -= subtrahend.M00;
            minuend.M01 -= subtrahend.M01;
            minuend.M02 -= subtrahend.M02;
        ...
        /// vector.
        /// </remarks>
        public static Vector3 MultiplyTransposed(Matrix33 matrix, Vector3 vector)
        {
            Vector3 result;
        ...
        /// <param name="scalar">The scalar.</param>
        /// <returns>The matrix with each element divided by scalar.</returns>
        public static Matrix33 Divide(Matrix33 matrix, float scalar)
        {
            float f = 1 / scalar;
            matrix.M00 *= f; matrix.M01 *= f; matrix.M02 *= f;
            matrix.M10 *= f; matrix.M11 *= f; matrix.M12 *= f;
        ...
        /// </remarks>
        public static bool operator ==(Matrix33 matrix1, Matrix33 matrix2)
        {
        ...
        /// 
        /// <summary>
        /// Performs an explicit conversion from <see cref="Matrix33"/> to a 2-dimensional 
        ...
        /// <summary>
        /// Converts this <see cref="Matrix33"/> to a 2-dimensional <see langword="float"/> array.
        /// </summary>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Matrix33"/> to a jagged 
        /// <see langword="float"/> array.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Converts this <see cref="Matrix33"/> to a jagged <see langword="float"/> array.
        /// </summary>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <overloads>
        /// <summary>
        /// Performs an implicit conversion from <see cref="Matrix33"/> to another data type.
        /// </summary>
        /// </overloads>
        /// 
        /// <summary>
        /// Performs an implicit conversion from <see cref="Matrix33"/> to <see cref="MatrixF"/>.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator Matrix(Matrix33 matrix)
        {
            Matrix result = new Matrix();


            result[0, 0] = matrix.M00; result[0, 1] = matrix.M01; result[0, 2] = matrix.M02; result[0, 3] = 0;
            result[1, 0] = matrix.M10; result[1, 1] = matrix.M11; result[1, 2] = matrix.M12; result[1, 3] = 0;
            result[2, 0] = matrix.M20; result[2, 1] = matrix.M21; result[2, 2] = matrix.M22; result[2, 3] = 0;
        ...
        /// <summary>
        /// Converts this <see cref="Matrix33"/> to <see cref="MatrixF"/>.
        /// </summary>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Matrix33"/> to <see cref="Matrix33D"/>.
        /// </summary>
        /// <param name="matrix">The matrix.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator Matrix33D(Matrix33 matrix)
        {
        ...
        /// <summary>
        /// Converts this <see cref="Matrix33"/> to <see cref="Matrix33D"/>.
        /// </summary>
        /// <returns>The result of the conversion.</returns>
        ...
        {
            M00 = (float)DoubleClassExtension.ClampToZero(M00);
            M01 = (float)DoubleClassExtension.ClampToZero(M01);
            M02 = (float)DoubleClassExtension.ClampToZero(M02);

            M10 = (float)DoubleClassExtension.ClampToZero(M10);
            M11 = (float)DoubleClassExtension.ClampToZero(M11);
            M12 = (float)DoubleClassExtension.ClampToZero(M12);

            M20 = (float)DoubleClassExtension.ClampToZero(M20);
            M21 = (float)DoubleClassExtension.ClampToZero(M21);
            M22 = (float)DoubleClassExtension.ClampToZero(M22);
        }
        ...
        {
            M00 = (float)DoubleClassExtension.ClampToZero(M00, epsilon);
            M01 = (float)DoubleClassExtension.ClampToZero(M01, epsilon);
            M02 = (float)DoubleClassExtension.ClampToZero(M02, epsilon);

            M10 = (float)DoubleClassExtension.ClampToZero(M10, epsilon);
            M11 = (float)DoubleClassExtension.ClampToZero(M11, epsilon);
            M12 = (float)DoubleClassExtension.ClampToZero(M12, epsilon);

            M20 = (float)DoubleClassExtension.ClampToZero(M20, epsilon);
            M21 = (float)DoubleClassExtension.ClampToZero(M21, epsilon);
            M22 = (float)DoubleClassExtension.ClampToZero(M22, epsilon);
        }
        ...
        public void Orthogonalize()
        {
            ...
            column1 = column1 - ProjectTo(column1, column0);
            column2 = column2 - ProjectTo(column2, column0) - ProjectTo(column2, column1);
        ...
        public bool TryInvert()
        {
            ...
            if (DoubleClassExtension.IsZero(determinant, float.Epsilon * float.Epsilon * float.Epsilon))
                return false;

            Matrix33 transposedAdjoint;
        ...
        public static Matrix33 Absolute(Matrix33 matrix)
        {
            return new Matrix33(Math.Abs(matrix.M00), Math.Abs(matrix.M01), Math.Abs(matrix.M02),
        ...
        /// </remarks>
        public static bool AreNumericallyEqual(Matrix33 matrix1, Matrix33 matrix2)
        {
        ...
        /// </remarks>
        public static bool AreNumericallyEqual(Matrix33 matrix1, Matrix33 matrix2, float epsilon)
        {
        ...
        /// otherwise it remains unchanged.
        /// </remarks>
        public static Matrix33 ClampToZero(Matrix33 matrix)
        {
            matrix.M00 = (float)DoubleClassExtension.ClampToZero(matrix.M00);
            matrix.M01 = (float)DoubleClassExtension.ClampToZero(matrix.M01);
            matrix.M02 = (float)DoubleClassExtension.ClampToZero(matrix.M02);

            matrix.M10 = (float)DoubleClassExtension.ClampToZero(matrix.M10);
            matrix.M11 = (float)DoubleClassExtension.ClampToZero(matrix.M11);
            matrix.M12 = (float)DoubleClassExtension.ClampToZero(matrix.M12);

            matrix.M20 = (float)DoubleClassExtension.ClampToZero(matrix.M20);
            matrix.M21 = (float)DoubleClassExtension.ClampToZero(matrix.M21);
            matrix.M22 = (float)DoubleClassExtension.ClampToZero(matrix.M22);
        ...
        /// remains unchanged.
        /// </remarks>
        public static Matrix33 ClampToZero(Matrix33 matrix, float epsilon)
        {
            matrix.M00 = (float)DoubleClassExtension.ClampToZero(matrix.M00, epsilon);
            matrix.M01 = (float)DoubleClassExtension.ClampToZero(matrix.M01, epsilon);
            matrix.M02 = (float)DoubleClassExtension.ClampToZero(matrix.M02, epsilon);

            matrix.M10 = (float)DoubleClassExtension.ClampToZero(matrix.M10, epsilon);
            matrix.M11 = (float)DoubleClassExtension.ClampToZero(matrix.M11, epsilon);
            matrix.M12 = (float)DoubleClassExtension.ClampToZero(matrix.M12, epsilon);

            matrix.M20 = (float)DoubleClassExtension.ClampToZero(matrix.M20, epsilon);
            matrix.M21 = (float)DoubleClassExtension.ClampToZero(matrix.M21, epsilon);
            matrix.M22 = (float)DoubleClassExtension.ClampToZero(matrix.M22, epsilon);
        ...
        public static Matrix33 CreateScale(float scale)
        {
        ...
        /// <returns>The created scaling matrix.</returns>
        public static Matrix33 CreateScale(float scaleX, float scaleY, float scaleZ)
        {
            Matrix33 result = new Matrix33
            {
                M00 = scaleX,
        ...
        /// </exception>
        public static Matrix33 CreateRotation(Vector3 axis, float angle)
        {
        ...
        /// <param name="angle">The rotation angle in radians.</param>
        /// <returns>The created rotation matrix.</returns>
        public static Matrix33 CreateRotationX(float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
        ...
        /// <param name="angle">The rotation angle in radians.</param>
        /// <returns>The created rotation matrix.</returns>
        public static Matrix33 CreateRotationY(float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
            return new Matrix33(cos, 0, sin,
                                 0, 1, 0,
                                 -sin, 0, cos);
        }
        ...
        /// <param name="angle">The rotation angle in radians.</param>
        /// <returns>The created rotation matrix.</returns>
        public static Matrix33 CreateRotationZ(float angle)
        {
            float cos = (float)Math.Cos(angle);
            float sin = (float)Math.Sin(angle);
            return new Matrix33(cos, -sin, 0,
                                 sin, cos, 0,
                                 0, 0, 1);
        }
