...
{
    public class VStabComponent : ECSGameComponent
    {
        public float Length;
        public float Twist;
        public float Chord;
        ...
        {
            VStabComponent other = new VStabComponent();
            other.Length = Length;
            other.Twist = Twist;
            other.Chord = Chord;
        ...
        {
            VStabComponent other = (VStabComponent)tother.FindGameComponentByName(Name);
            other.Length = Length;
            other.Twist = Twist;
            other.Chord = Chord;
            other.Incidence = Incidence;
