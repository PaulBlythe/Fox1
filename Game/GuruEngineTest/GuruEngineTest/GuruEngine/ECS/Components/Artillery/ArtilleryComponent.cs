...
//( Class ArtilleryComponent )
//( Group Artillery )
//( Type ArtilleryComponent )
...
{
    public class ArtilleryComponent : ECSGameComponent
    {
        ...
        {
            ArtilleryComponent other = new ArtilleryComponent();
        ...
        {
            ArtilleryComponent otherTank = (ArtilleryComponent)other.FindGameComponentByName(Name);
