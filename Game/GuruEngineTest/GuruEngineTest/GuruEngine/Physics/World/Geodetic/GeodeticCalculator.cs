...
namespace GuruEngine.Physics.World.Geodetic
{
    public class GeodeticCalculator
    {
        ...
        public static float GetApproximateDistance(GlobalCoordinates pos1, GlobalCoordinates pos2)
        {
            double Lat1, Lon1, Lat2, Lon2;

            Lat1 = pos1.Latitude.Radians;
            Lon1 = pos1.Longitude.Radians;
            Lat2 = pos2.Latitude.Radians;
            Lon2 = pos2.Longitude.Radians;
        ...
        public static float CalculateXDistance(double latitude, double Lon1, double Lon2)
        {
            double m_per_deg_lon = (3.14159265359 / 180) * 6367449 * Math.Cos(latitude);
            double deltaLon = Lon2 - Lon1;
            return (float)(deltaLon * m_per_deg_lon);
        }
