...
namespace GUITestbed.Rendering._3D
{
    public class SkyDomeSystem
    {
        ...
        public SkyDomeSystem(Game game, Camera camera, GameTime gameTime, GraphicsDevice graphicsDevice)
        {
            this.game = game;
            this.camera = camera;
        ...
        public void Initialize()
        {
            ...
            this.mieRT = new RenderTarget2D(game.GraphicsDevice, 256, 128, true, SurfaceFormat.HalfVector4, DepthFormat.None);
            this.rayleighRT = new RenderTarget2D(game.GraphicsDevice, 256, 128, true, SurfaceFormat.HalfVector4, DepthFormat.None);
            ...
            WeatherChange(Weather.SomeClouds);
        }
        #endregion
        ...
        public void Update(GameTime gameTime)
        {
            ...
            //if (realTime)
            {
                int minutes = (Game1.Instance.GameDateTime.Hour * 60) + (Game1.Instance.GameDateTime.Minute);
        ...
        private void DrawMoon(Matrix View, Matrix Projection, Vector3 CameraPosition)
        {
            ...
            texturedEffect.CurrentTechnique = texturedEffect.Techniques["BasicColorDrawing"];
        ...
        public void DrawClouds(Matrix View, Matrix Projection, Vector3 CameraPosition)
        {
            ...
            noiseEffect.CurrentTechnique = noiseEffect.Techniques["BasicColorDrawing"];
